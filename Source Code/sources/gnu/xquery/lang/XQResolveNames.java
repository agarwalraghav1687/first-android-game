...
public class XQResolveNames extends ResolveNames {
    ...
    public Expression visitApplyExp(ApplyExp exp, Void ignored) {
                    ...
                    switch (code) {
                        ...
                        case XS_QNAME_BUILTIN /*-35*/:
                            ...
                            if (args[0] instanceof QuoteExp) {
                                ...
                                ApplyExp app = new ApplyExp(ClassType.make("gnu.xquery.util.QNameUtils").getDeclaredMethod("resolveQName", 3), new Expression[]{args[0], quoteExp2, new QuoteExp(this.parser.prologNamespaces)});
                                app.setFlag(4);
                                return app;
                            }
        ...
        if (proc2 instanceof Type) {
            ...
            ApplyExp applyExp3 = new ApplyExp(XQParser.makeFunctionExp("gnu.xquery.util.CastAs", "castAs"), new Expression[]{exp.getFunction(), args9[0]});
            return applyExp3;
        }
