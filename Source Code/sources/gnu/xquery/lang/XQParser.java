...
public class XQParser extends Lexer {
        ...
        while (true) {
            ...
            if (next == delimiter) {
                if (delimiter == '<') {
                    ...
                    if (this.tokenBufferLength > 0) {
                        ...
                        applyExp = new ApplyExp(makeText, new Expression[]{quoteExp});
                    }
                    this.tokenBufferLength = 0;
                    if (next2 != 47) {
            ...
            if (next == delimiter || next < 0 || next == 123) {
                ...
                if (postBrace == 123) {
                    ...
                    ApplyExp applyExp2 = new ApplyExp(makeText, new Expression[]{quoteExp2});
            ...
            case 256:
                ...
                if (this.curToken == 123) {
                    ...
                    if (token == 253 || token == 254 || token == PI_TOKEN) {
                        vec2.addElement(parseExprSequence(125, token == PI_TOKEN));
  ...
  mth insns count: 1130
    ...
    public Expression parse(Compilation comp2) throws IOException, SyntaxException {
        ...
        peekOperand();
        if (this.curToken == NCNAME_TOKEN && "namespace".equals((String) this.curValue)) {
            if (warnOldVersion) {
        ...
        switch (this.curToken) {
            case DECLARE_BASE_URI_TOKEN /*66*/:
                ...
                return QuoteExp.voidExp;
            case DEFAULT_ELEMENT_TOKEN /*69*/:
            case DEFAULT_FUNCTION_TOKEN /*79*/:
                boolean forFunctions = this.curToken == DEFAULT_FUNCTION_TOKEN;
                ...
                parseSeparator();
                return QuoteExp.voidExp;
            case DEFAULT_COLLATION_TOKEN /*71*/:
            ...
            case DEFAULT_ORDER_TOKEN /*72*/:
                ...
                parseSeparator();
                return QuoteExp.voidExp;
            case IMPORT_MODULE_TOKEN /*73*/:
                break;
            case DECLARE_CONSTRUCTION_TOKEN /*75*/:
                getRawToken();
            ...
            case 78:
                ...
                break;
            case DECLARE_FUNCTION_TOKEN /*80*/:
            ...
            case 83:
                ...
                parseSeparator();
                return QuoteExp.voidExp;
            case IMPORT_SCHEMA_TOKEN /*84*/:
                break;
            case DECLARE_ORDERING_TOKEN /*85*/:
                ...
                parseSeparator();
                return QuoteExp.voidExp;
            case DECLARE_VARIABLE_TOKEN /*86*/:
                getRawToken();
                Declaration decl = parseVariableDeclaration();
                if (decl == null) {
                    return syntaxError("missing Variable");
                    ...
                    if (match("encoding")) {
                        ...
                        while (true) {
                            ...
                            if (i >= 0 && !bad) {
                                ...
                                if ((ch3 < NCNAME_TOKEN || ch3 > 'Z') && ((ch3 < 'a' || ch3 > 'z') && (i == 0 || !((ch3 >= '0' && ch3 <= '9') || ch3 == '.' || ch3 == '_' || ch3 == '-')))) {
                                    bad = true;
                                }
                            } else if (bad) {
