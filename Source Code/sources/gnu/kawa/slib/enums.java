...
public class enums extends ModuleBody {
    ...
    static {
        ...
        define$Mnenum = Macro.make(simpleSymbol2, new ModuleMethod(enums, 1, null, 4097), $instance);
        $Prvt$$Pcdefine$Mnenum = Macro.make(Lit21, new ModuleMethod(enums, 2, null, 4097), $instance);
        $instance.run();
    }
