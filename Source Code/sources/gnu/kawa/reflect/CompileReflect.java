    ...
    public static Expression validateApplySlotGet(ApplyExp exp, InlineCalls visitor, Type required, Procedure proc) {
        ...
        if (isStatic) {
            ...
            if ("class".equals(name)) {
                ...
                ApplyExp applyExp = new ApplyExp(Compilation.typeType.getDeclaredMethod("getReflectClass", 0), new Expression[]{arg0});
                return applyExp;
            } else if (type != null) {
                QuoteExp quoteExp2 = new QuoteExp(type);
                ApplyExp applyExp2 = new ApplyExp(exp.getFunction(), new Expression[]{quoteExp2, arg1});
        ...
        if (type instanceof ObjectType) {
            ...
            if (part != null) {
                ...
                ApplyExp applyExp3 = new ApplyExp(exp.getFunction(), new Expression[]{arg0, quoteExp3});
