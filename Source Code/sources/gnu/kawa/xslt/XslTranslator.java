...
public class XslTranslator extends Lexer implements Consumer {
    ...
    public void endElement() {
        ...
        if (xslTag == "value-of") {
            ...
            ApplyExp applyExp2 = new ApplyExp((Expression) new QuoteExp(defineTemplateProc), new Expression[]{resolveQNameExpression(name), quoteExp2, new QuoteExp(DFloNum.make(0.0d)), resolveQNameExpression(mode2), this.templateLambda});
