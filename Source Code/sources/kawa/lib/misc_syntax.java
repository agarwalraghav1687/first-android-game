...
public class misc_syntax extends ModuleBody {
    ...
    static {
        ...
        provide = Macro.make(simpleSymbol5, new ModuleMethod(misc_syntax, 1, null, 4097), $instance);
        SimpleSymbol simpleSymbol6 = Lit8;
        ModuleMethod moduleMethod = new ModuleMethod(misc_syntax, 2, null, 4097);
        ...
        ModuleMethod moduleMethod2 = new ModuleMethod(misc_syntax, 3, null, 4097);
        ...
        include$Mnrelative = Macro.make(Lit18, new ModuleMethod(misc_syntax, 4, null, 4097), $instance);
        $instance.run();
    }
