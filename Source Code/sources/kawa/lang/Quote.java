...
public class Quote extends Syntax {
    ...
    /* JADX INFO: used method not loaded: gnu.expr.ApplyExp.<init>(gnu.bytecode.Method, gnu.expr.Expression[]):null, types can be incorrect */
        ...
        while (true) {
                    ...
                    if (p1 instanceof Pair) {
                        ...
                        if ((p2 instanceof Pair) && p2.getCdr() == LList.Empty) {
                            ...
                            if (sym != null) {
                                ...
                                r4 = r30;
                                rewrite_car = new ApplyExp(quoteType.getDeclaredMethod("makeSymbol", 2), new Expression[]{QuoteExp.getInstance(ns), part2});
            ...
            if (car == r25.getCar()) {
                ...
                if ((car instanceof Expression) || (cdr2 instanceof Expression)) {
                    r4 = r30;
                    rewrite_car = new ApplyExp(makePairMethod, new Expression[]{coerceExpression(car, tr), coerceExpression(cdr2, tr)});
                } else {
                    r4 = r30;
